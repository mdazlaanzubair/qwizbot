...
const GrammarForm = () => {
  ...
  const { setCorrectedText } = useGrammarContext();
  ...
  const correctIt = async (formData) => {
  ...
  return (
    <form className="card w-full" onSubmit={handleSubmit(correctIt)}>
      <div className="card-body">
        <h2 className="card-title text-3xl font-bold">Wanna Grammify?</h2>
        ...
        <div className="card-actions justify-end mt-5">
          <button className="btn btn-sm btn-success">Correct</button>
        </div>
      </div>
    </form>
  );
